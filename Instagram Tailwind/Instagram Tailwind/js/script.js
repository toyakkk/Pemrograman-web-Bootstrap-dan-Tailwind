...
const samplePosts = [
    { id: 1, image: 'us.jpg', likes: 3121, comments: 211 },
];
...
const profileData = {
    ...
    website: '',
    postsCount: 1,
    followersCount: '1,124',
    followingCount: '1,147'
};
...
function showEmptyState(tabName) {
    ...
    const icons = {
        reposts: 'fas fa-retweet', 
        tagged: 'fas fa-user-tag'
    };
    
    const messages = {
        reposts: { title: 'No Reposts Yet', subtitle: 'Repost will appear here' },
        tagged: { title: 'No posts yet', subtitle: '' }
    };
